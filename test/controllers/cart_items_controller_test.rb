...
class CartItemsControllerTest < ActionController::TestCase
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post :create, cart_item: { number: @cart_item.number, reference: @cart_item.reference, reference: @cart_item.reference }
    end
  ...
  test "should update cart_item" do
    patch :update, id: @cart_item, cart_item: { number: @cart_item.number, reference: @cart_item.reference, reference: @cart_item.reference }
    assert_redirected_to cart_item_path(assigns(:cart_item))
  end
